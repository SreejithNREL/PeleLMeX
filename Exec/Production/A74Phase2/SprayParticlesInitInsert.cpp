...
CounterFlowJet::get_new_particle(
  ...
  Real* Y_part)
{
  //Changing the properties for A74 Phase 2 simulations
  umag = m_jetVel;
  T_part = m_jetT;
...
bool SprayParticleContainer::injectParticles(  Real time,
                                               Real dt,
                                               int nstep,
                                               int lev,
                                               int finest_level,
